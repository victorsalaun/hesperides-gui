...
(function () {
    ...
    angular
        .module('hesperides.feedback')
        .controller('FeedbackCtrl', FeedbackController);

    FeedbackController.$inject = ['$translate'];

    /* @ngInject */
    function FeedbackController($translate) {
        var vm = this;
        vm.feedbackRoomName = hesperidesConfiguration.feedbackRoomName;
